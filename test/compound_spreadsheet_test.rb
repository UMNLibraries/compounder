...
module Compounder
  describe CompoundSpreadsheet do
    ...
    it 'converts a row' do
      ...
      file_klass.expect :read, 'transcript numero uno', ['foo/bar/transcripts/bausong-001.tif']
      ...
      valid_csv = File.read(File.join(File.dirname(__FILE__), '/fixtures/compound.csv'))
